...
subroutine DISCON (avrSWAP, aviFAIL, avcINFILE, avcOUTNAME, avcMSG) bind(c,name='DISCON')
   ...
   if (( iStatus > 0 ) .and. ( aviFAIL >= 0 ) )  then
     ...
     ! write(*,*) 'Swap array value for gen speed is ' ,avrSWAP(20)
      array1( 2) = dble(avrSWAP(20))/gearboxRatio   !    2: For Bladed/OpenFAST: convert Generator speed to rotor speed
     ! array1( 2) = dble(avrSWAP(21))            !    2: For HAWC2: constraint bearing1 shaft_rot 1 only 2 
